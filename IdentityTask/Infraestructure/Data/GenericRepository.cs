...
{
    private readonly IdentityTaskDbContext _context;
    private readonly ISpecificationEvaluator _specificationEvalutator;
    private readonly ILogger<GenericRepository<T>> _logger;

    public GenericRepository(IdentityTaskDbContext context, ILogger<GenericRepository<T>> logger) : this(context, SpecificationEvaluator.Default, logger) { }

    public GenericRepository(IdentityTaskDbContext context, ISpecificationEvaluator specificationEvalutator, ILogger<GenericRepository<T>> logger)
    {
